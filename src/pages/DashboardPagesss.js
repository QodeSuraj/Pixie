  ...
  return (
    <div>
      ...
      <div className="bg-white max-w-full mx-4 h-auto sm:max-w-[80%] sm:mx-auto md:max-w-[61%] lg:w-[65%]">
        <div className="px-10">
          <div>
            <h1 className="text-sm text-gray-900 mt-10 sm:text-xl">
              Dashboard
            </h1>
            <div>
                  ...
                  {item.subDescription.map((description, index) => (
                    <div key={index} className=" hidden lg:block  ">
                      <ul className="hover:bg-gray-100 py-3 ">
                        <li className=" ">
                          <p className="text-[10px] md:text-[12px] px-0 text-center text-gray-600  ">
                            {description}
                          </p>
                        </li>
                      </ul>
            ...
            <div className="mt-10 py-10 ">
              ...
              <div className="grid md:grid-cols-2 grid-cols-1 my-10 py-10">
                ...
                <div className="h-[200px] flex flex-col gap-y-7 ">
                  ...
                  <p className="text-[12px]">
                    Spread the love and earn referral credits for every friend
                    you refer. Invite friends now.
                  </p>
                </div>
              </div>
            </div>
